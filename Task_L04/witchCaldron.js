"use strict";
var L04_witchCaldron;
(function (L04_witchCaldron) {
    window.addEventListener("load", handleLoad);
    let totalPrice = 0;
    function handleLoad(_event) {
        console.log("Start");
        //fill content
        L04_witchCaldron.generateContent(L04_witchCaldron.data);
    ...
    function handleIngrediengts(_event) {
        let ingLength = L04_witchCaldron.data["Ingredients"].length;
        ...
        for (let i = 0; i < ingLength; i++) {
            ...
            if (checkbox.checked) {
                ...
                let name = L04_witchCaldron.data["Ingredients"][i].name;
                let price = L04_witchCaldron.data["Ingredients"][i].price;
...
})(L04_witchCaldron || (L04_witchCaldron = {}));
